      ...
      <Container className="flex flex-wrap ">
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            ...
            <h2>Your Partner in Optimizing Google Business Profiles</h2>
            <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
            At LocalSoc, we specialize in helping businesses unlock their full potential by 
            optimizing their Google Business Profiles (GBP). With a tailored approach, we 
            ensure your profile not only stands out but also attracts more local customers. 
            From auditing your GBP to managing reviews and crafting keyword-rich content, 
            we are here to make your business visible where it matters most.
            </p>
